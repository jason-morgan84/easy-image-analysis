...
version = "0.1.0"
class CodeOutputMissingArguementImagePixelArray(ImageOperation):
    
    def __init__(self):
        super().__init__(
            name = "Code outout missing arguement image pixel array",
            category = "",
            version = "0.2",
            docs = "Returns an image output with missing pixel array",
            alerts = None,
